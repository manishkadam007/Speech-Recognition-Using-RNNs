...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    for i in range(recur_layers):
        rnn = GRU(units, activation='relu',
            return_sequences=True, implementation=2, name='rnn_'+str(i+1))(input_data)
        # TODO: Add batch normalization 
...
def bidirectional_rnn_model(input_dim, units, output_dim=29):
    ...
    bidir_rnn = Bidirectional(GRU(units, activation='relu',
        return_sequences=True, implementation=2, name='bi_rnn'))(input_data)
    # TODO: Add a TimeDistributed(Dense(output_dim)) layer
...
def final_model(input_dim, units, output_dim=29):
    ...
    bidir_rnn_1 = Bidirectional(GRU(units, activation='relu',
        return_sequences=True, implementation=2, name='bi_rnn_1'))(bn_cnn)
    bn_bidir_rnn_1 = BatchNormalization(name='bn_bidir_rnn_1')(bidir_rnn_1)
    bidir_rnn_2 = Bidirectional(GRU(units, activation='relu',
        return_sequences=True, implementation=2, name='bi_rnn_2'))(bn_bidir_rnn_1)
